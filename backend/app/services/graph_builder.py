...
Interfaz 2: Creación de grafos independientes mediante la API de Zep
"""
...
class GraphBuilderService:
    ...
    def build_graph_async(
        ...
        """
        Construcción asíncrona de grafos
        
        Args:
            text: Texto de entrada
            ontology: Definición de ontología (salida de la interfaz 1)
            graph_name: Nombre del grafo
            chunk_size: Tamaño del bloque de texto
            chunk_overlap: Tamaño de superposición de bloques
            batch_size: Número de bloques por lote
        ...
        # Ejecutar la construcción en un hilo en segundo plano
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        """Establecer ontología del grafo (método público)"""
        import warnings
        ...
        # Este es el uso requerido por Zep SDK, las advertencias provienen de la creación dinámica de clases y se pueden ignorar de forma segura
        warnings.filterwarnings('ignore', category=UserWarning, module='pydantic')
        
        # Nombres reservados de Zep, no se pueden usar como nombres de atributos
        ...
        # Crear tipos de entidades dinámicamente
        entity_types = {}
        for entity_def in ontology.get("entity_types", []):
            ...
            for attr_def in entity_def.get("attributes", []):
                ...
                # La API de Zep requiere description de Field, esto es obligatorio
        ...
        # Crear tipos de aristas dinámicamente
        edge_definitions = {}
        for edge_def in ontology.get("edge_types", []):
            ...
            for attr_def in edge_def.get("attributes", []):
                ...
                # La API de Zep requiere description de Field, esto es obligatorio
                attrs[attr_name] = Field(description=attr_desc, default=None)
                annotations[attr_name] = Optional[str]  # Los atributos de arista usan el tipo str
        ...
        # Llamar a la API de Zep para establecer la ontología
    ...
    def add_text_batches(
        ...
        """Agregar texto en lotes al grafo, devuelve una lista de todos los uuid de episode"""
        episode_uuids = []
        total_chunks = len(chunks)
        ...
        for i in range(0, total_chunks, batch_size):
            ...
            try:
                ...
                # Recopilar los uuid de episode devueltos
    ...
    def _wait_for_episodes(
        ...
        """Esperar a que todos los episode se procesen (consultando el estado processed de cada episode)"""
        ...
        while pending_episodes:
            ...
            # Verificar el estado de procesamiento de cada episode
            for ep_uuid in list(pending_episodes):
                try:
                    ...
                    # Ignorar errores de consulta individuales y continuar
                    pass
    ...
    def _get_graph_info(self, graph_id: str) -> GraphInfo:
        ...
        # Obtener nodos (paginado)
        nodes = fetch_all_nodes(self.client, graph_id)

        # Obtener aristas (paginado)
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        """
        Obtener datos completos del grafo (incluyendo información detallada)
        
        Args:
            graph_id: ID del grafo
            
        Returns:
            Diccionario que incluye nodes y edges, con información detallada como tiempo y atributos
        """
        nodes = fetch_all_nodes(self.client, graph_id)
        edges = fetch_all_edges(self.client, graph_id)
